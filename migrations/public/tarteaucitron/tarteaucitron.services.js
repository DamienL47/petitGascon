...
tarteaucitron.services.facebookpage = {
    ...
    "js": function () {
        ...
        tarteaucitron.fallback(['tac_facebookpage'], function (x) {
            ...
            return '<iframe title="' + frame_title + '" src="https://www.facebook.com/plugins/page.php?href=' + encodeURIComponent(url) + '&amp;width=' + width + '&amp;show_text=false&amp;appId=' + appId + '&amp;height=' + height + '" width="' + width + '" height="' + height + '" scrolling="auto" allowtransparency allowfullscreen></iframe>';
        });
    },
    "fallback": function () {
        "use strict";
