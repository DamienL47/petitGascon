...
class __TwigTemplate_de01811fb1616b9e8bf260a67bcd207c3c4f0ecc7cf60d070b587b43585e9199 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn connect\">{{ button_label|default('Enregistrer') }}</button>
{{ form_end(form) }}
", "admin/category/_form.html.twig", "/Applications/MAMP/htdocs/petitGascon/templates/admin/category/_form.html.twig");
    }
}
