...
class getMailer_TransportFactory_MailgunService extends App_KernelProdContainer
{
    ...
    {
        return new \Symfony\Component\Mailer\Bridge\Mailgun\Transport\MailgunTransportFactory(($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()), ($container->privates['http_client'] ?? $container->load('getHttpClientService')), ($container->privates['monolog.logger.mailer'] ?? $container->load('getMonolog_Logger_MailerService')));
    }
}
